# 📋 Project Charter – TENTORA

## Project Purpose

The purpose of this project is to develop **TENTORA**, an AI-powered and curated creative-solutions platform that helps project owners find suitable creative work through two connected paths:

1. **Design Now:** Browse and customize Ready Designs created by approved creatives.
2. **Work With a Creative:** Discover visual taste and receive relevant creative, studio, or team recommendations.

The platform organizes creative discovery by sector and service, allowing users to explore designs and creative work without completing a long questionnaire or creating an account at the beginning.

---

## Project Objectives

1. To develop a functional MVP that presents creative services and designs across five initial sectors.

2. To make all five sectors visible and clickable within the prototype:
...
3. To build **Restaurants & Cafés** as the first complete end-to-end functional pilot.

4. To allow users to browse and customize selected Ready Designs without requiring initial registration.

5. To provide an AI-powered prompt that interprets the user’s request and recommends relevant templates, services, or creatives.

6. To allow clients to complete a visual Taste Discovery experience and receive one reusable **Main Taste Profile**.

7. To return no more than six relevant creative, studio, or team recommendations.

8. To demonstrate a connected journey from Ready Design customization to professional creative support.

9. To preserve creator attribution, ownership, permissions, licensing, and commercial rights.
...
The primary users of the MVP are **project owners, entrepreneurs, and organizations** seeking creative services within the following sectors:
...
| :--- | :--- | :--- |
| **Sector Discovery** | • Five visible and clickable sectors<br>• Relevant creative-service categories<br>• Curated design examples<br>• Clearly labeled demo content | • Additional sectors outside the five approved categories<br>• Unrestricted user-created categories |
| **Restaurants & Cafés Pilot** | • Complete functional sector journey<br>• Ready Designs<br>• Basic customization<br>• Taste Discovery<br>• Creative matching<br>• Professional handoff | • Complete functional implementation of every service in all five sectors |
| **Ready Designs** | • Browse designs by sector and service<br>• Edit approved properties<br>• Preview, save, and export<br>• Creator attribution and licensing | • Blank-canvas design tools<br>• Open publishing without TENTORA approval<br>• Advanced motion and 3D editing |
| **Create with AI** | • Interpret user prompts<br>• Recommend relevant templates<br>• Suggest services or creatives<br>• Prepare structured starting points | • Fully autonomous generation of complete editable designs<br>• Training on creative work without permission |
| **Taste Discovery** | • Image-based visual selections<br>• Main Taste Profile<br>• Optional service-specific refinement | • Advanced behavioral recommendation models<br>• Unlimited taste profiles within one project |
| **Creative Matching** | • Match by sector, service, taste, and Creative DNA<br>• Maximum of six recommendations<br>• Explain recommendation reasons | • Large unfiltered lists<br>• Automated contracts, pricing, or team scheduling |
| **Explore Creatives** | • Creative profiles<br>• Portfolios<br>• Services and sector experience<br>• Ready Designs | • Unverified public profiles<br>• Uncurated portfolio publishing |
| **Project Workspace** | • Project summary<br>• Messages and files<br>• References and feedback<br>• Milestones and delivery status | • Real-time collaborative editing<br>• Advanced enterprise project management |
| **Authentication** | • Explore without login<br>• Progressive authentication when saving, exporting, purchasing, or collaborating | • Mandatory registration before browsing |
| **Payments & Operations** | • Basic purchase concept may be demonstrated | • Complex escrow, taxation, accounting, settlement, and multi-country compliance |
| **Platform Support** | • Responsive web experience | • Native iOS and Android applications |
...
`Select Sector → Select Service → Browse Ready Designs → Customize → Preview → Save or Export`

This path is intended for users who need a fast and usable creative result.

### ✨ Create with AI

`Describe the Need → Interpret the Request → Recommend Templates, Services, or Creatives`

The MVP will focus on AI-assisted discovery and recommendation rather than unrestricted design generation.

### 🤝 Work With a Creative

`Select Sector and Services → Complete Taste Discovery → Receive Main Taste Profile → View Up to Six Recommendations → Select Creative → Open Project Workspace → Delivery`

### 🔄 Design-to-Creative Handoff

`Saved Ready Design → Continue With a Creative → Transfer Content and Edits → Professional Development`

The user should not be required to re-enter information already saved during customization.
...
TENTORA simplifies the process of finding and obtaining creative work by transforming a fragmented experience into a **visual, structured, and connected journey**.
